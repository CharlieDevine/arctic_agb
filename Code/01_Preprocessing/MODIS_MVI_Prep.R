...
mvi.025deg.regrid.fun = function(mvi.name){
  ...
  resample.fun = function(mvi.infile, mvi.outfile){
    ...
    # Upper and lower limits of EVI are 1 and -0.2, respectively - set these to NA
    if (mvi.name == 'EVI'){
      mvi.orig[mvi.orig > 1] = NA
      mvi.orig[mvi.orig < -0.2] = NA
    }

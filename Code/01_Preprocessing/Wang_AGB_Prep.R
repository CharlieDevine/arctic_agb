...
# vod.fp = 'C:/Users/cjdev/Desktop/ABoVE/VODCA/X_Band/Extended_Domain_Daily/2007'
# setwd(vod.fp)
# 
# vod.daily = stack(list.files(vod.fp, pattern = '.tif', full.names = FALSE, recursive = FALSE))
# 
# vod.mean = mean(vod.daily, na.rm = TRUE)
# vod.ext = extent(vod.mean)

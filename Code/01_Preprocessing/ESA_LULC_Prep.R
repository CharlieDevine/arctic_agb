...
shp.fp = paste(root.fp, 'Github', 'ABoVE_AGB_VOD', 'Data', 'Shapefiles', 'Domain', sep = '/')
...
landmask.grid = raster(paste(root.fp, 'Github', 'ABoVE_AGB_VOD', 'Data', 'VODCA_ABoVE_Land_Mask.tif', sep = '/'))
